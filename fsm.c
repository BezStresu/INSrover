...
// Welcome sequence 
	...
	ledCntrl(RED, ON); ledCntrl(GREEN, OFF); ledCntrl(BLUE, OFF);
	led_delay();
	ledCntrl(RED, OFF); ledCntrl(GREEN, OFF); ledCntrl(BLUE, OFF);
	led_delay();
	...
	ledCntrl(RED, OFF); ledCntrl(GREEN, ON); ledCntrl(BLUE, OFF);
	led_delay();
	ledCntrl(RED, OFF); ledCntrl(GREEN, OFF); ledCntrl(BLUE, OFF);
	led_delay();
	
	ledCntrl(RED, OFF); ledCntrl(GREEN, OFF); ledCntrl(BLUE, ON);
	led_delay();
	ledCntrl(RED, OFF); ledCntrl(GREEN, OFF); ledCntrl(BLUE, OFF);
	led_delay();
